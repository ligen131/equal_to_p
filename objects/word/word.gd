...
const STEP := 36 ## 在字符动画的资源文件夹（[code]res://objects/word/sprites[/code]）中，同一个字符相邻帧之间的文件编号差。
const LETTER_NAME: Array[String] = [" ", "=", "P", "b", "D",
"I1", "I2", "I3", "I4", "I5",
"R", "Q", "d", "q", "(",
"*", "+", "<", ">", ")",
"0", "1", "2", "3", "4",
...
func update_animation() -> void:
	ImageLib.update_animation(self, text_id + 1, 3, STEP, "res://objects/word/assets/exports/sprite%d.png")
