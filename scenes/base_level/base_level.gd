...
# 不知道为什么改成 preload 会有运行时问题，就不改了（反正大家不关心 preformance
var BlockScn = load("res://objects/block/block.tscn")
var CardBaseScn = load("res://objects/card_base/card_base.tscn")
var LevelMenuScn = load("res://scenes/level_menu/level_menu.tscn")
var TableClothScn = load("res://objects/table_cloth/table_cloth.tscn")
var BaseLevelScn = load("res://scenes/base_level/base_level.tscn")
